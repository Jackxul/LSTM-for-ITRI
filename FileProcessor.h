...
class FileProcessor {
	public:
	    ...
	    void add_data(MYSQL*& conn , std::string tableName , int db_id , int line_id , char *date , float handover , float delay1 , float delay2 , float delay3 , float delay4 , float total_delay);
