...
int main() {
	...
	CROW_ROUTE(app, "/")([](){
		...
		"0 , 2021/05/03 , 0.9848320 , 0.2212331 , 0.1321231 , 0.4267233 , 0.1472371 , 0.3428359",
		"1 , 2021/05/04 , 0.9848321 , 0.2212332 , 0.1321232 , 0.4267234 , 0.1472372 , 0.3428360",
		"2 , 2021/05/05 , 0.9848322 , 0.2212333 , 0.1321233 , 0.4267235 , 0.1472373 , 0.3428361",
		"3 , 2021/05/06 , 0.9848323 , 0.2212334 , 0.1321235 , 1.4267232 , 1.1472366 , 1.3428357",
		"4 , 2021/05/07 , 0.9848324 , 0.2212335 , 0.1321237 , 2.4267230 , 2.1472364 , 2.3428356",
		"5 , 2021/05/08 , 0.9848325 , 0.2212337 , 0.1321243 , 3.4267229 , 3.1472363 , 3.3428354",
		"6 , 2021/05/09 , 0.9848326 , 0.2212338 , 0.1321244 , 4.4267228 , 4.1472362 , 4.3428348",
		"7 , 2021/05/10 , 0.9848327 , 0.2212340 , 0.1321245 , 5.4267227 , 5.1472361 , 5.3428347",
		"8 , 2021/05/11 , 0.9848328 , 0.2212341 , 0.1321248 , 6.4267226 , 6.1472357 , 6.3428346",
		"9 , 2021/05/12 , 0.9848329 , 0.2212342 , 0.1321251 , 7.4267225 , 7.1472356 , 7.3428344",
		"10 , 2021/05/13 , 0.9848330 , 0.2212344 , 0.1321252 , 8.4267224 , 8.1472349 , 8.3428337",
		"11 , 2021/05/14 , 0.9848331 , 0.2212345 , 0.1321254 , 9.4267223 , 9.1472347 , 9.3428336",
		"12 , 2021/05/15 , 0.9848332 , 0.2212346 , 0.1321255 , 10.4267222 , 10.1472346 , 10.3428333",
		"13 , 2021/05/16 , 0.9848333 , 0.2212347 , 0.1321256 , 11.4267224 , 11.1472345 , 11.3428334"};
		...
		while(count < 14){
			...
			xul["Date"] = Jack_API_vec[1];
			xul["Handover"] = Jack_API_vec[2];
			xul["DRB_RlcUL"] = Jack_API_vec[3];
			xul["DRB_AirUL"] = Jack_API_vec[4];
			xul["DRB_RlcDL"] = Jack_API_vec[5];
			xul["DRB_AirDL"] = Jack_API_vec[6];
			xul["Total_Delay"] = Jack_API_vec[7];
			//outter["xul"] = xul;
			outter.insert({Jack_API_vec[0], xul});
			count++;
		}

		std::map<std::string, crow::json::wvalue> response(outter.begin(), outter.end());
